...
public:
	...
	/**
	 * Méthode retournant VRAI si les deux premiéres cartes de la main ont le méme EType. Retourne FAUX sinon.
	 * @see Card::getType()
	 * @return Booléen.
	 */
	bool isPair();
	 ...
	 * Il faut absolument appeler delete aprés l'appel de cette fonction!
	 */
	void deleteHand();
