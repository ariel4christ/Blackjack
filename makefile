all: Bank.o Card.o Hand.o Participant.o Player.o PlayerHand.o BankCommunication.o PlayerCommunication.o AI.o BankInterface.o HMI.o BankGame.o AIGame.o UserGame.o
